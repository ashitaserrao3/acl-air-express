...
def run():
                ...
                st.set_page_config(
                    page_title="PCF South",
                    layout="wide"
                )
                
                st.markdown("## 📦PCF South Processor")
                
                # =================================================
                # FILE UPLOADER
                # =================================================
                uploaded_files = st.file_uploader(
                    "Upload PCF South Excel files",
                    type=["xlsx"],
                ...
                if uploaded_files:
                    ...
                    with st.spinner(
                        ...
                        for i, file in enumerate(uploaded_files):
                            ...
                            try:
                                ...
                                df_clean["total_frt"] = safe_get("NET")
                    ...
                    if all_dfs:
                        ...
                        st.download_button(
                            "📥 Download Excel",
                            data=output,
                            file_name="PCF_South_Combined.xlsx",
